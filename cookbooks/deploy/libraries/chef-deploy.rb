    ...
    class EyDeploy < Chef::Provider
      ...
      def load_current_resource
        ...
        @dep = CachedDeploy.new :user                  => @new_resource.user,
                                ...
                                :git_ssh_wrapper       => @new_resource.git_ssh_wrapper
      end
...
Chef::Platform.platforms[:default].merge! :ey_deploy => Chef::Provider::EyDeploy, :gem_package => Chef::Provider::Package::Rubygems

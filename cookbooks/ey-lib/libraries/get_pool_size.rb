  ...
  module PoolSize
    ...
    class Calculator
      ...
      Resources.merge!( {
        ...
        "m3.2xlarge"   => InstanceResource.new( 8,   26,  nil               ),
        "t2.micro"     => InstanceResource.new( 1,   3.25, nil               ),
        "t2.small"     => InstanceResource.new( 1,   3.25, nil               ),
        ...
        "t3.2xlarge"   => InstanceResource.new( 8,   31,  nil               ),
	"t3a.micro"    => InstanceResource.new( 2,   4,  nil		    ),
	"t3a.small"     => InstanceResource.new( 2,   8,   nil               ),
        "t3a.medium"    => InstanceResource.new( 2,   8,   nil               ),
        "t3a.large"     => InstanceResource.new( 2,   8,   nil               ),
        "t3a.xlarge"    => InstanceResource.new( 4,   16,  nil               ),
        "t3a.2xlarge"   => InstanceResource.new( 8,   31,  nil               ),
        ...
        "m5.8xlarge"   => InstanceResource.new( 32,  128,  nil               ),
        "m5.12xlarge"  => InstanceResource.new( 48,  173, nil               ),
        "m5.16xlarge"  => InstanceResource.new( 64,  256, nil               ),
        ...
        "m5a.8xlarge"  => InstanceResource.new( 32,  128,  nil               ),
        "m5a.12xlarge" => InstanceResource.new( 48,  173, nil               ),
        "m5a.16xlarge" => InstanceResource.new( 64,  256, nil               ),
        ...
        "m5d.8xlarge"  => InstanceResource.new( 32,  128,  nil               ),
        "m5d.12xlarge" => InstanceResource.new( 48,  173, nil               ),
        "m5d.16xlarge" => InstanceResource.new( 64,  256, nil               ),
        ...
        "c5.12xlarge"   => InstanceResource.new( 48,  188, nil               ),
        "c5.18xlarge"  => InstanceResource.new( 72,  281, nil               ),
        "c5.24xlarge"  => InstanceResource.new( 96,  375, nil               ),
        ...
        "c5d.12xlarge"  => InstanceResource.new( 48,  188, nil               ),
        "c5d.18xlarge" => InstanceResource.new( 72,  281, nil               ),
        "c5d.24xlarge" => InstanceResource.new( 96,  375, nil               ),
        "c5a.large"    => InstanceResource.new( 2,   10,   nil               ),
        "c5a.xlarge"   => InstanceResource.new( 4,   20,  nil               ),
        "c5a.2xlarge"  => InstanceResource.new( 8,   39,  nil               ),
        "c5a.4xlarge"  => InstanceResource.new( 16,  73,  nil               ),
        "c5a.8xlarge"  => InstanceResource.new( 32,  125, nil               ),
        "c5a.12xlarge"  => InstanceResource.new( 48,  187, nil               ),
        "c5a.16xlarge" => InstanceResource.new( 64,  250, nil               ),
        "c5a.24xlarge" => InstanceResource.new( 96,  375, nil               ),
        ...
        "r5.8xlarge"   => InstanceResource.new( 32,  128,  nil               ),
        "r5.12xlarge"  => InstanceResource.new( 48,  173, nil               ),
        "r5.16xlarge"  => InstanceResource.new( 64,  256, nil               ),
        ...
        "r5d.8xlarge"  => InstanceResource.new( 32,  128,  nil              ),
        "r5d.12xlarge" => InstanceResource.new( 48,  173, nil               ),
        "r5d.16xlarge" => InstanceResource.new( 64,  256, nil               ),

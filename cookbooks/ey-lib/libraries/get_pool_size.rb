...
class Engineyard
  module PoolSize
	...
	"t3a.micro"    => InstanceResource.new( 2,   1,  nil		    ),
	"t3a.small"     => InstanceResource.new( 2,   2,   nil               ),
        "t3a.medium"    => InstanceResource.new( 2,   4,   nil               ),
        "t3a.large"     => InstanceResource.new( 2,   8,   nil               ),
        "t3a.xlarge"    => InstanceResource.new( 4,   16,  nil               ),
        "t3a.2xlarge"   => InstanceResource.new( 8,   32,  nil               ),
        ...
        "c5a.large"    => InstanceResource.new( 2,   4,   nil               ),
        "c5a.xlarge"   => InstanceResource.new( 4,   8,  nil               ),
        "c5a.2xlarge"  => InstanceResource.new( 8,   16,  nil               ),
        "c5a.4xlarge"  => InstanceResource.new( 16,  32,  nil               ),
        "c5a.8xlarge"  => InstanceResource.new( 32,  64, nil               ),
        "c5a.12xlarge"  => InstanceResource.new( 48,  96, nil               ),
        "c5a.16xlarge" => InstanceResource.new( 64,  128, nil               ),
        "c5a.24xlarge" => InstanceResource.new( 96,  192, nil               ),
        ...
        "r5d.8xlarge"  => InstanceResource.new( 32,  256,  nil              ),
        "r5d.12xlarge" => InstanceResource.new( 48,  173, nil               ),
        "r5d.16xlarge" => InstanceResource.new( 64,  512, nil               ),

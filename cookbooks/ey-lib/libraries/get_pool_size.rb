...
class Engineyard
  module PoolSize
	...
	"t3a.small"     => InstanceResource.new( 2,   8,   nil               ),
        ...
        "c5a.large"    => InstanceResource.new( 2,   9,   nil               ),
        "c5a.xlarge"   => InstanceResource.new( 4,   17,  nil               ),
        "c5a.2xlarge"  => InstanceResource.new( 8,   34,  nil               ),
        "c5a.4xlarge"  => InstanceResource.new( 16,  68,  nil               ),
        "c5a.8xlarge"  => InstanceResource.new( 32,  132, nil               ),
        "c5a.12xlarge"  => InstanceResource.new( 48,  188, nil               ),
        "c5a.16xlarge" => InstanceResource.new( 64,  256, nil               ),
